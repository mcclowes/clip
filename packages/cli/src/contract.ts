...
export const contract = {
  ...
  commands: [
    ...
    { name: 'registry show', description: 'Inspect a community schema and its provenance.', mutating: false, args: [arg('id', 'Registry entry ID.', true)] },
    { name: 'registry install', description: 'Register an installed executable with a verified community schema. Does not install or run the executable.', mutating: true, args: [arg('id', 'Registry entry ID.', true), arg('--purpose', 'When agents should use this tool.', true)] },
  ],
